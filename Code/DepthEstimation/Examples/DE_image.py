...
# Invert values so lower depths become high intensity (-> red in JET) and higher depths become low intensity (-> blue)
depth_uint8_inv = 255 - depth_uint8

# Make a color image (use the inverted uint8 for the colormap)
depth_color = cv2.applyColorMap(depth_uint8_inv, cv2.COLORMAP_JET)
